...
<link rel="stylesheet" href="${pageContext.request.contextPath}/jsp/android/css/news.css" />
...
<script type="text/javascript" src="${pageContext.request.contextPath}/jsp/android/js/news.js"></script>
