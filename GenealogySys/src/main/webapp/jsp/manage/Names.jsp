...
<script src="${pageContext.request.contextPath}/js/names.js"></script>
	...
	<div class="container-fluid">
		<div class="panel panel-info">
			<div class="panel-heading"
				...
				<h4 class="panel-title">姓氏文化信息</h4>
			</div>
		...
		<div class="panel panel-info">
			<div class="panel-heading"
				...
				<h4 class="panel-title">添加姓氏文化</h4>
			</div>
			<div class="panel-body">	
		...
		<div class="am-modal-dialog">
			<div class="panel panel-info">
				<div class="panel-heading"
					...
					<h3 class="panel-title">姓氏文化内容查看</h3>
				</div>
				<div id="newsInfo" class="panel-body">
					<form method="post" class="form-horizontal" role="form">
						...
						<div class="form-group">
							<label for="firstname" class="col-sm-2 control-label">姓氏内容:</label>
							<div class="col-sm-10">
